...
public class SmsUtils {
        ...
        public static void sendMobileSms(String mobile) throws IOException, URISyntaxException {
            ...
            /**************** 查账户信息调用示例 *****************/
            System.out.println(SmsUtils.getUserInfo(apikey));
            ...
            System.out.println(SmsUtils.tplSendSms(apikey, tpl_id, tpl_value, mobile));
