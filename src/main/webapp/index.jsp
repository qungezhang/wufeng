...
<main class="gn-body">
    ...
    <section class="about-km template" id="about-km">
        <div class="wrapper">
            ...
            <div class="contact">
                ...
                <p>销售热线：15921215218</p>
                <p>技术热线：13816377155</p>
    ...
    <section class="my-center template" id="my-center">
        ...
        <div class="me-content">
            <!--***我的积分 start ***-->
            <div class="m-wrap me-point-wrap" id="me-point-wrap">
            ...
            <div class="m-wrap me-order-wrap" id="me-order-wrap">
                ...
                <footer class="p-g">
                    <span class="js-o-prev">上一页</span>
                    <span class="js-o-page-index">1</span>
                    <span class="js-o-next">下一页</span>
                </footer>
            </div>
            ...
            <!--******我的任务 任务列表 start ******-->
            <div class="m-wrap me-job-wrap" id="me-job-wrap">
                <header class="row m-header">
                    <div class="col-xs-9 m-h-left">
                        任务列表
                    </div>
                ...
                <ul class="m-j-list">
                    <li class="m-j-item template">
                        <div class="row m-j-info js-job-detail">
                            <div class="col-xs-8">
                                <p class="js-j-title">直流变频器打不着火（全国可接）</p>
                                <p class="js-j-jid">任务编号：R180800001</p>
                                <p class="js-j-time">截至时间：07-23 16:30</p>
                            </div>
                            <div class="col-xs-3 f-right">
                                <p class="js-j-examineStatus">待审核</p>
                                <p class="js-j-money">¥100</p>
                            </div>
                        </div>
                    </li>
                </ul>
                <footer class="p-g">
                    <span class="js-j-prev">上一页</span>
                    <span class="js-j-page-index">1</span>
                    <span class="js-j-next">下一页</span>
                </footer>
            </div>
            <div class="m-wrap me-jobDetail-wrap" id="me-jobDetail-wrap">
                <header class="row m-header">
                    <div class="col-xs-9 m-h-left">
                        任务详情
                    </div>
                </header>
                <div class="jd-baseinfo">
                    <div class="col-xs-8">
                        <p class="js-jd-title">直流变频器打不着火（全国可接）</p>
                        <p class="js-jd-jid">工作区域：上海市-徐汇区</p>
                        <p class="js-jd-time">截至时间：07-23 16:30</p>
                    </div>
                    <div class="col-xs-3 f-right">
                        <p class="js-jd-examineStatus">待审核</p>
                        <p class="js-jd-money">¥100</p>
                    </div>
                </div>
                <div class="jd-content">
                    <h4>任务描述</h4>
                    <p class="m-jd-list">
                        <span class="js-jd-description">
                                    1、测试整流电路 找到变频器内部直流电源的P端和N端，将万用表调到电阻X10档，红表棒接到P，黑表棒分别依到R、S、T，
                                    正常时有几十欧的阻值，且基本平衡。相反将黑表棒接到P端，红表棒依次接到R、S、T，有一个接近于无穷大的阻值。
                                    将红表棒接到N端，重复以上步骤，都应得到相同结果。如果有以下结果，可以判定电路已出现异常，
                                    A.阻值三相不平衡，说明整流桥有故障。B.红表棒接P端时，电阻无穷大，可以断定整流桥故障或启动电阻出现故障。
                                    2、测试逆变电路 将红表棒接到P端，黑表棒分别接U、V、W上，应该有几十欧的阻值，且各相阻值基本相同，反相应该为无穷大。
                                    将黑表棒N端，重复以上步骤应得到相同结果，否则可确定逆变模块有故障。
                                </span>
                    </p>
                    <h4>雇主详情</h4>
                    <p class="m-jd-list">
                        <div class="col-xs-12">1.雇主姓名:
                            <span class="js-jd-employerName">戴先生</span>
                        </div>
                        <div class="col-xs-12">2.联系方式:
                            <span class="js-jd-employerMobile"> 17621762100</span>
                        </div>
                        <div class="col-xs-12">3.详细地址:
                            <span class="js-jd-address">上海市徐汇区宜山路810号</span>
                        </div>
                    </p>
                </div>
            </div>
